    ...
    return (
        <div className='bg-[#121212] flex flex-col lg:flex-row justify-between items-center text-white border-b-4 border-b-cyan'>
            ...
            >
                ...
                <form onSubmit={handleSubmit} className='bg-[#424242] p-8 rounded-md border-2 border-custom-blue border-opacity-40 w-full lg:min-w-[480px] text-white'>
                    ...
                    <div>
                        ...
                        <div className='flex gap-2 mt-4 border px-3 py-3 rounded-md'>
                            <Person3Icon />
                            <input required name='name' className='w-full bg-transparent border-0 focus:outline-0' type="text" placeholder='Enter Your name' />
                        </div>
                    </div>
                    <div className='mt-6'>
                        ...
                        <div className='flex gap-2 mt-4 border px-3 py-3 rounded-md'>
                            <EmailIcon />
                            <input required name='email' className='w-full bg-transparent border-0 focus:outline-0' type="email" placeholder='Enter Your email' />
                        </div>
                    </div>
                    <div className='mt-6'>
                        ...
                        <div className='flex gap-2 mt-4 border px-3 py-3 rounded-md'>
                            <CallIcon />
                            <input required name='phone' className='w-full bg-transparent border-0 focus:outline-0' type="text" placeholder='Enter Your mobile number' />
                        </div>
                    </div>

                    <div className='mt-6'>
                        <label>Class<span className='text-red-600'>*</span></label>
                        <div required className='flex gap-2 mt-4 border px-3 py-3 rounded-md'>
                            <ListIcon />
                            <select required name='selectClass' className='w-full bg-[#424242] border-0 focus:outline-0' type="" placeholder='Enter Your mobile number'>
                    ...
                    <div className='mt-8 flex gap-2 items-start'>
                        <input type='submit' value={'Download Brochure'} href='https://drive.google.com/uc?export=download&id=1-g7Bsun3RvKAezjWFZOL9QOvlnfcELRk' className='w-full bg-gradient-to-r from-cyan to-green hover:shadow-lg hover:shadow-[#121212] py-3 rounded-md hover:bg-opacity-60 hover:transition-all hover:delay-200 hover:ease-out font-bold text-center' />
                    </div>
                </form>
            ...
            <div className='pt-40 lg:pb-0 pb-20 lg:pl-28 pl-10 w-full'>
                ...
                <div className='flex flex-wrap mt-8 gap-3'>
                    ...
                    <button onClick={handleClickOpen} className='hover:shadow-[#424242] border-2 py-3 min-w-[250px] text-2xl rounded-lg  hover:shadow-lg'>Download Brochure</button>
                </div>
            </div>
