...
const EUFooter = () => {
  const navItems = (
    <>
      ...
      <Link>Cookie & Privacy Policy</Link>
    </>
  );
    ...
    <div className="bg-[#141414] text-white">
      ...
      <div>
        <footer className="px-10 lg:px-32 text-white">
          <div className="container flex flex-col justify-between py-10 mx-auto">
            ...
            <div className="grid grid-cols-1 mt-20">
              <div>
                ...
                <div className="flex">
                  <ul className="flex flex-col mt-3">{navItems}</ul>
                </div>
              </div>
          ...
          <div className="py-6 text-sm text-end text-white mt-[-50px]">
            © 2023 Experiment Labs. All rights reserved.
          </div>
        </footer>
      </div>
    </div>
