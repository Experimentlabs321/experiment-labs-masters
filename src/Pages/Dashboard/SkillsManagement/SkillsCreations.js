...
const SkillsCreations = () => {
    ...
    const handlecreatenewClick = () => {
        ...
        const storedCategories = JSON.parse(localStorage.getItem('skillsManagementcategories')) || [];
        ...
        localStorage.setItem('skillsManagementcategories', JSON.stringify(storedCategories));
