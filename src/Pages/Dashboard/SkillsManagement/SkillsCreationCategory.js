...
const SkillsCreationCategory = () => {
  ...
  const handleOptionChangecourse = (event) => {
    ...
    if (isChecked) {
      ...
      setSelectedOptionscourse(
        selectedOptionscourse.filter((option) => option !== optionValue)
      );
    }
  };
  ...
  const [selectedOptionscoursepopup2, setSelectedOptionscoursepopup2] =
    useState([]);
  ...
  const handleOptionChangecoursepopup2 = (event) => {
    ...
    if (isChecked) {
      setSelectedOptionscoursepopup2([
        ...selectedOptionscoursepopup2,
        optionValue,
      ]);
    } else {
      setSelectedOptionscoursepopup2(
        selectedOptionscoursepopup2.filter((option) => option !== optionValue)
      );
    }
  };
  ...
  const [selectedOptionscoursepopup3, setSelectedOptionscoursepopup3] =
    useState([]);
  ...
  const handleOptionChangecoursepopup3 = (event) => {
    ...
    if (isChecked) {
      setSelectedOptionscoursepopup3([
        ...selectedOptionscoursepopup3,
        optionValue,
      ]);
    } else {
      setSelectedOptionscoursepopup3(
        selectedOptionscoursepopup3.filter((option) => option !== optionValue)
      );
    }
  };
    ...
    <div className="mx-10 mt-14">
      ...
      <div className="flex gap-7">
        <div
          ...
          className="h-[216px] bg-[#DBDBDB] w-[182px] flex flex-col justify-center items-center mt-2 rounded-2xl"
          ...
          <div className="popup-content ">
            ...
            >
              <div className="ps-[37px] pt-[48px] pe-[28px]">
                ...
                <div className=" ">
                  <input
                    className="mt-11 mb-11 w-[170px] border text-center"
                    type="text"
              ...
              <div className="flex-1 lg:grid grid-cols-3 mt-5 ">
                <div className=" ">
                  <div className=" ">
                    ...
                    <div
                      className=" flex gap-2 h-[40px] w-[90%] px-2 text-[#535353] "
                      style={{
                        borderRadius: "8px",
                  ...
                  <div className=" ">
                    ...
                    <div
                      className="custom-dropdown flex justify-between items-center gap-2 h-[40px] w-[90%] px-2 text-[#535353] font-normal"
                      style={{
                        borderRadius: "8px",
                        border: "1px solid var(--neutral-300, #BFBFBF)",
                      }}
                    ...
                    {isOpenEvluation && (
                      <div
                        className="dropdown-menu w-[90%] mt-2"
                        style={{
                          borderRadius: "8px",
                          border: "1px solid var(--neutral-300, #BFBFBF)",
                        }}
                ...
                <div className=" ">
                  ...
                  <div className=" ">
                    ...
                    {isOpencourse && (
                      <div className="dropdown-menu w-[90%] mt-2 rounded border">
                        <div className="flex justify-end p-2">
                          <input
                            className="me-3"
                            type="checkbox"
                        ...
                        <ul className="p-3 ">
                          ...
                          >
                            <input
                              ...
                              name="option"
                              value="Student"
                              checked={selectedOptionscourse.includes(
                                "Student"
                              )}
                ...
                <div class="">
                  <div
                    className="flex justify-end pe-5"
                    onClick={handleClosePopup}
                  >
                    <button className="flex justify-center items-center rounded-full w-6 h-6 bg-[#A1A1A1] font-bold text-[#000000]">
                      x
                    </button>
                  </div>
                </div>
                ...
                <div className="flex items-end justify-center mb-8">
                  <button className="bg-[#2EB0FB] rounded-lg h-[30px] w-[95px] font-semibold text-[#fff]">
                    Proceed
                  </button>
                </div>
              </div>
            ...
            {!isPopupOpen1 && (
              <div className="bg-[#001E75] flex justify-center items-center h-[40px] mx-5 rounded-b-3xl mb-5">
                <button
                  ...
                  className=" flex justify-center items-center border-2 rounded-full h-[32px] w-[32px] text-[30px] text-[#ffffff]"
                >
                  +
                </button>
              </div>
