                            ...
                            <div className="flex-1 lg:grid grid-cols-3 mt-5 ">
                                ...
                                <div className=" ">
                                    ...
                                    <div className=' '>
                                        ...
                                        <div className=" flex gap-2 h-[40px] w-[90%] px-2 text-[#535353] "
                                            style={{
                                                borderRadius: "8px",
                                    ...
                                    <div className=' '>
                                        ...
                                        <div className="custom-dropdown flex justify-between items-center gap-2 h-[40px] w-[90%] px-2 text-[#535353] font-normal"
                                            style={{
                                                borderRadius: "8px",
                                                border: "1px solid var(--neutral-300, #BFBFBF)"
                                            }}
                                        ...
                                        {isOpenEvluation && (
                                            <div className="dropdown-menu w-[90%] mt-2"
                                            style={{
                                                borderRadius: "8px",
                                                border: "1px solid var(--neutral-300, #BFBFBF)"
                                            }}
