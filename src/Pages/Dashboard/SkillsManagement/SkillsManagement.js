        ...
        <div>
            <Layout>
                ...
                <div className='my-12 grid grid-cols-1 lg:grid-cols-2 gap-7 px-7'>
                    <Link to='/skillsCreations' className="WithMedia w-full h-fit p-6 bg-white rounded-2xl shadow flex-col justify-start items-start gap-4 inline-flex">
                        <div className="CardTop self-stretch justify-start items-start gap-4 inline-flex">
                            <img className="Image w-40 h-44 relative rounded-lg" src={image1} alt='' />
                            <div className="Content grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                                <div className="CardTitle self-stretch text-black text-[24px] font-normal leading-normal">Skills Creations</div>
                    ...
                    <Link to='/skillsImprovementEngine' className="WithMedia w-full h-fit p-6 bg-white rounded-2xl shadow flex-col justify-start items-start gap-4 inline-flex">
                        <div className="CardTop self-stretch justify-start items-start gap-4 inline-flex">
                            <img className="Image w-40 h-44 relative rounded-lg" src={Image2} alt=''/>
                            <div className="Content grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                                <div className="CardTitle self-stretch text-black text-[24px] font-normal leading-normal">Skills Improvement Engine</div>
                                <div className="CardDesription self-stretch"><span className="text-zinc-900 text-[16px] font-normal leading-normal">Card desription. </span><span className="text-zinc-900 text-[16px] font-normal leading-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit rhoncus imperdiet nisi.</span></div>
                            </div>
                        </div>
                    </Link>
