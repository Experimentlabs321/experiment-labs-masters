                            ...
                            <div class="lg:grid grid-cols-4  gap-2 p-5">
                                <div className='row-span-2 flex flex-col justify-center items-center '>
                                    ...
                                    <div className='mt-10 '>
                                        <div className=''>
                                            ...
                                            <input className='mt-2 border rounded-lg w-[200px] h-[150px] ps-2 text-center text-[#535353] focus:outline-0 ' type="text" placeholder='description' ></input>
                                ...
                                <div className="">
                                    ...
                                    <div className=' mt-6'>
                                        ...
                                        <div className=" lg:flex justify-between items-center  gap-2   h-[40px] w-[300px] px-5 text-[#535353] ">
                                            <div>
                                    ...
                                    <div className=' mt-6'>
                                        <div className=''>
                                            ...
                                            <input className='mt-2 border rounded-lg w-[300px] h-[40px] ps-2 text-[#535353] focus:outline-0 ' type="text" placeholder='Enter Parameter Name' ></input>
                                        </div>
                                    </div>
                                </div>
                                <div className="">
                                    ...
                                    <div className=' mt-6 '>
                                        ...
                                        <div className=" lg:flex gap-2  border  rounded-lg h-[40px] w-[300px] px-2 text-[#535353] ">
                                ...
                                <div class="row-span-3  ">
                                    ...
                                    <div className='mt-20'>
                                        ...
                                        <div className='lg:flex mt-[50px] items-center'>
                                            <p className='font-bold text-base me-[30px]'>Minimum Value</p>
                                            <div className="text-[18px]  h-[40px] flex  ">
                                                <button style={{ boxShadow: " 0px 0px 16px -2px rgba(0, 0, 0, 0.50)" }} className=' border w-[55px] text-[#000000] rounded-s-full text-center' onClick={() => setminValue(minValue - 1)}>-</button>
                                                <span className='w-[38px] flex justify-center items-center'> {minValue} </span>
                                                <button style={{ boxShadow: " 0px 0px 16px -2px rgba(0, 0, 0, 0.50)" }} className='border w-[55px] text-[#000000] rounded-e-full text-center' onClick={() => setminValue(minValue + 1)}>+</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
