...
const AddRedemptionPointItemForm = ({
    ...
    const [selectedRedemptionOption, setSelectedRedemptionOption] = useState("External");
    ...
    const handleAddRedemptionItem = async (event) => {
        ...
        if (newItem?.data?.acknowledged) {
            ...
            const otherCategories = redemptionCategories?.filter(
                (item) => selectedRedemptionCategory?.categoryName !== item?.categoryName
            );
            setRedemptionCategories([
                {
                    categoryName: selectedRedemptionCategory?.categoryName,
                    ...
                    <form onSubmit={handleAddRedemptionItem} className="w-full">
                        <div className="flex">
                            <div>
                                ...
                                <textarea className="mt-5 border rounded-lg h-[100px] ps-2  text-[#000000] focus:outline-0 " placeholder="description" id="description" name="description" rows="5" cols="18"/>
                            </div>
                                    ...
                                    <div className=' '>
                                        ...
                                        <div className="   w-[100%]  text-[#535353] ">
                                            ...
                                            >
                                                {
                                                    course?.map((week) => (
                                                        <option value={week?.weekName}> {week?.weekName}</option>
                                                    ))
                                                }
