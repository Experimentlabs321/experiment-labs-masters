    ...
    const handleEditRedemptionItem = async (event) => {
        ...
        if (data?.categoryName === selectedRedemptionCategory?.categoryName) {
            ...
            if (updatedItem?.data?.acknowledged) {
                ...
                const updateItemsArray = [...selectedRedemptionCategory?.redemptionItems];
                const selectedRedemptionLogicIndex = updateItemsArray?.findIndex(
                    (item) =>
                        item?.redemptionItemName === selectedRedemptionLogic?.redemptionItemName
                );
                ...
                updatedCategoriesArray[selectedIndex].redemptionItems = updateItemsArray;
                    ...
                    <form onSubmit={handleEditRedemptionItem} className="w-full">
                        <div className="flex">
                            <div>
                                ...
                                <textarea className="mt-5 border rounded-lg h-[100px] ps-2  text-[#000000] focus:outline-0 " defaultValue={selectedRedemptionLogic?.description} id="description" name="description" rows="5" cols="18" />
                            </div>
                            ...
                            <div className="w-full pl-8">
                                <div className="grid grid-cols-1 gap-x-6 gap-y-4 mt-2 sm:grid-cols-2 w-full">
                                    ...
                                    <div className=' '>
                                        <p className='font-semibold text-[#000000]  py-2'>Redemption Level</p>
                                        <div className="   w-[100%]  text-[#535353] ">
                                            ...
                                            >
                                                {
                                                    course?.map((week) => (
                                                        <option defaultValue={week?.weekName}> {week?.weekName}</option>
                                                    ))
                                                }
                                    ...
                                    <div className="flex flex-col gap-10 mt-5">
                                        ...
                                        <div className="flex justify-between items-center ">
                                            ...
                                            <div className="text-[18px] w-[40%]  h-[40px] flex  ">
                                                ...
                                                <input
                                                    value={minimumValue}
                                                    onChange={(e) => setMinimumValue(parseInt(e.target.value))}
                                                    className="w-[60%] focus:outline-none flex justify-center items-center text-center font-sans"
                                                    type="number"
                                                    name="minimumValue"
                                                    id="minimumValue"
