...
const EarningLogics = () => {
    ...
    const handlecreatenewClick = () => {
        ...
        const storedCategories = JSON.parse(localStorage.getItem('earningcategories')) || [];
        ...
        <div>
            <Layout>
                ...
                <div className='flex items-center justify-center gap-7 pt-20 lg:pt-10 '>
                    <div className="UserManagement origin-top-left rotate-[-0.51deg] text-zinc-500 text-[30px] font-medium">Earning Logics</div>
                ...
                <div className='lg:flex justify-center items-center mt-5 '>
                    <div className='flex-1 justify-center items-center lg:flex gap-4 px-10'>
                        <button
                            ...
                            className={`px-6 py-3 text-base border rounded-md font-semibold ${category === 'Category'
                        ...
                        {allcategories?.map(cat => <>
                            <button
                                /* key={index} */
                                className={`px-6 py-3 text-base border rounded-md font-semibold ${category === cat
                                    ? 'text-[#0A98EA] border-t-2 border-t-[#0A98EA]'
                                    : 'text-[#949494]'
                                    }`}
