        ...
        <div className="popup  mt-5">
          <div className="popup-content ">
            <div className="border rounded-lg ">
              <div class="lg:flex gap-5 p-5">
                <div className="w-[70%] row-span-2 flex flex-col justify-center items-center  ">
                  <div
                    style={{
                      backgroundImage: `url(${img1})`,
                      background: `linear-gradient(0deg, rgba(46, 176, 251, 0.20) 0%, rgba(46, 176, 251, 0.20) 100%), lightgray 50% / cover no-repeat`,
                    }}
                    className=" w-[60%] flex justify-center items-end rounded-lg mt-5"
                  >
                  ...
                  <div className="mt-10 ">
                    <div className="">
                      <p className=" px-6 py-2 text-[#ffffff] rounded-3xl bg-[#2EB0FB] text-center">
                        Upload
                      </p>
                    </div>
                  </div>
                ...
                <div className=" w-full">
                  <div className=" ">
                    ...
                    <div className=" flex  border  rounded-lg h-[40px] w-[100%] px-2 text-[#535353] ">
                      <select
                        required
                  ...
                  <div className=" ">
                    ...
                    <div className=" flex gap-2  border  rounded-lg h-[40px] w-[100%] px-2 text-[#535353] font-normal">
                      <select
                        required
                        className="w-full border-0 focus:outline-0 "
                        name="option"
                ...
                <div className=" w-full mt-20">
                  <div className=" ">
                    ...
                    <div className=" flex gap-2  border  rounded-lg h-[40px] w-[100%] px-2 text-[#535353] ">
                      <select
                        required
                        className="w-full border-0 focus:outline-0"
                        name="option"
              ...
              <div className="flex justify-end gap-4 mx-7 mb-8">
                <button className="bg-[#2EB0FB] rounded-lg px-4 py-2 font-semibold text-[#fff]">
                  Save
                </button>
                <button className="bg-[#2EB0FB] rounded-lg px-4 py-2 font-semibold text-[#fff]">
                  Save All
