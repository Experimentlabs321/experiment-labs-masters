...
const AffiliateName = () => {
    ...
    return (
        ...
        >
            <p className="flex items-center text-3xl font-semibold gap-2 ps-10 pt-20"><Link to='/planning' ><ArrowBackIcon /></Link> <span><img src={icon} alt="icon" /></span>Experiment Labs
            </p>
            <div className="flex">
