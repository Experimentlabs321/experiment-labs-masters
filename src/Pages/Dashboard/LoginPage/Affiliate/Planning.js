...
const Planning = () => {
    ...
    return (
        ...
        >
            <p className="flex items-center text-3xl font-semibold gap-2 pt-20 ms-10"><Link to='/affiliateType' ><ArrowBackIcon /></Link> <span><img src={icon} alt="icon" /></span>Experiment Labs
            </p>
            <div className="flex">
                <div className="w-[100%] flex flex-col items-center ">
                    
                    <p className=' text-4xl font-extrabold  mt-[80px] '>How are you Planning to use Experiment Labs ?</p>
                    <p className='text-[#8F8F8FCC] text-xl font-semibold mt-[30px]'>We’ll fit the experience to your needs. Don’t worry, you can change it later.</p>
