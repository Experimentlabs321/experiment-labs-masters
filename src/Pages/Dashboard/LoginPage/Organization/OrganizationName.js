...
const OrganizationName = () => {
    ...
    return (
        ...
        >
            <p className="flex items-center text-3xl font-semibold gap-2 ps-[100px] pt-[100px]"><Link to='/organizationType' ><ArrowBackIcon /></Link> <span><img src={icon} alt="icon" /></span>Experiment Labs
            </p>
            <div className="flex">
                <div className="w-[100%] flex flex-col items-center ">

                    <p className=' text-4xl font-extrabold mt-20 '>Name your Organization </p>
