...
const StudentSignUpUserDetails = () => {
    ...
    return (
        <div className="">
            <p className="flex items-center text-3xl font-semibold gap-2 pt-20 ms-10"><Link to='/studentSignUpAcademicDetails' ><ArrowBackIcon /></Link> <span><img src={icon} alt="icon" /></span>Experiment Labs
            </p>
            <div className="flex">
                <div className='mt-10'>
                ...
                <div className="w-[100%] flex justify-center bg-[#fff] mt-7">
                    <div>
                        ...
                        <p className="flex items-center text-xl font-medium gap-5 justify-center py-1 w-[500px] mt-[55px]"
                            style={{
                                borderRadius: "10px",
                       ...
                       <p className="flex items-center text-xl font-medium gap-5  py-2 w-[500px] mt-[54px] ps-3 "
                        ...
                        <p className="flex items-center text-lg font-semibold gap-5 justify-center py-1 w-[500px] mt-[53px]"
            ...
            <div className='flex justify-between items-center mt-[58px] mx-20 mb-10'>
...
export default StudentSignUpUserDetails;
