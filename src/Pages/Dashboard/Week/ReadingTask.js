  ...
  return (
    <div>
      ...
      <div className="min-h-[72vh] mb-[60px] ">
            ...
            taskData?.additionalFiles.endsWith(".docx") ? (
              <>
                <iframe
                  ...
                  height="80vh"
                ></iframe>
                <div className="flex items-center text-sm font-semibold gap-1 absolute top-28 right-56 z-10">
              ...
              <>
                <img
                  ...
                  height="80vh"
                />
                <div className="flex items-center text-xl font-semibold gap-1 absolute top-24 right-12 z-10">
        ...
        <a
          href="//www.dmca.com/Protection/Status.aspx?ID=f9cd86e6-c90e-4bd4-9098-079a6168195e"
          title="DMCA.com Protection Status"
          class="dmca-badge"
        >
          {" "}
          <img
            src="https://images.dmca.com/Badges/dmca-badge-w100-5x1-10.png?ID=f9cd86e6-c90e-4bd4-9098-079a6168195e"
