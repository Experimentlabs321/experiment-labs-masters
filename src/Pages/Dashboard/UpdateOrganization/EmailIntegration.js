...
const ComponentB = () => <div className="mt-4 p-4 w-full text-center font-bold text-red-600 text-3xl rounded-lg">Coming Soon</div>;
    ...
    return (
        <div className="flex flex-col items-start justify-center px-4 mt-6 w-full">
            <div className="flex items-center gap-3">
                <label htmlFor="mailOption" className='font-bold'>Select An Option</label>
                <select
                    id='mailOption'
