...
const AssignmentDetails = () => {
    ...
    useEffect(() => {
        if (userInfo) {
            ...
            axios
                .get(
                    `${process.env.REACT_APP_SERVER_API}/api/v1/language/getContentManageSubDetailsByOrganizationAndName/assignment/organizationsId/${userInfo?.organizationId}`
                )
                .then((response) => {
    ...
    const handleSubmit = async (event) => {
        ...
        const newAssignmentTotalPointsOrMarksName = form.assignmentTotalPointsOrMarks?.value;
        ...
        const newAssignmentStartingDateAndTimeName = form.assignmentStartingDateAndTime?.value;
        const newAssignmentEndingDateAndTimeName = form.assignmentEndingDateAndTime?.value;
        ...
        const item = await axios.post(
            `${process.env.REACT_APP_SERVER_API}/api/v1/language/addContentManageSubDetails/assignment/organizationId/${userInfo?.organizationId}`,
            itemDetail
        );
        console.log(item)
                    ...
                    <form onSubmit={handleSubmit} className='mt-2 border p-4 rounded-xl'>
                        <div className=' grid grid-cols-2 gap-4'>
                            ...
                            <div className='flex justify-between items-center w-[100%]'>
                                ...
                                <input name='manageAssignmentIn' defaultValue={itemDetails?.manageAssignmentIn} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
                            </div>
                            <div className='flex justify-between items-center w-[100%]'>
                            ...
                            <div className='flex justify-between items-center w-[100%]'>
                                ...
                                <input name='assignmentName' defaultValue={itemDetails?.assignmentName} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
                            </div>
                            <div className='flex justify-between items-center w-[100%]'>
                                <p className='text-lg font-medium'>Assignment Total Points/Marks</p>
                                <input name='assignmentTotalPointsOrMarks' defaultValue={itemDetails?.assignmentTotalPointsOrMarks} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
                            </div>
                            <div className='flex justify-between items-center w-[100%]'>
                                <p className='text-lg font-medium'>Assignment Instructions</p>
                                <input name='assignmentInstructions' defaultValue={itemDetails?.assignmentInstructions} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
                            </div>
                            <div className='flex justify-between items-center w-[100%]'>
                                <p className='text-lg font-medium'>Upload Files</p>
                                <input name='uploadFiles' defaultValue={itemDetails?.uploadFiles} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
                            </div>
                            <div className='flex justify-between items-center w-[100%]'>
                            ...
                            <div className='flex justify-between items-center w-[100%]'>
                                ...
                                <input name='contentStage' defaultValue={itemDetails?.contentStage} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
                            </div>
                            <div className='flex justify-between items-center w-[100%]'>
                            ...
                            <div className='flex justify-between items-center w-[100%]'>
                                <p className='text-lg font-medium'>Assignment Starting Date and Time</p>
                                <input name='assignmentStartingDateAndTime' defaultValue={itemDetails?.assignmentStartingDateAndTime} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
                            </div>
                            <div className='flex justify-between items-center w-[100%]'>
                                <p className='text-lg font-medium'>Assignment Ending Date and Time</p>
                                <input name='assignmentEndingDateAndTime' defaultValue={itemDetails?.assignmentEndingDateAndTime} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
                            </div>
                            <div className='flex justify-between items-center w-[100%]'>
