...
const AdminAssignmentsDetails = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const item = await axios.post(
      `${process.env.REACT_APP_SERVER_API}/api/v1/language/addNavItemsDetails/assignments/organizationId/${userInfo?.organizationId}`,
      itemDetails
    );
    console.log(item)
          ...
          <form onSubmit={handleSubmit} className='mt-2 border p-4 rounded-xl'>
            <div className=' grid grid-cols-2 gap-4'>
              ...
              <div className='flex justify-between items-center w-[100%]'>
                ...
                <input name='pendingEvaluations' defaultValue={itemDetails?.pendingEvaluations} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              ...
              <div className='flex justify-between items-center w-[100%]'>
                ...
                <input name='selectStatus' defaultValue={itemDetails?.selectStatus} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
                <p className='text-lg font-medium'>Apply Filters</p>
                <input name='applyFilters' defaultValue={itemDetails?.applyFilters} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
              ...
              <div className='flex justify-between items-center w-[100%]'>
                ...
                <input name='submissionDate' defaultValue={itemDetails?.submissionDate} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
                <p className='text-lg font-medium'>Status</p>
                <input name='status' defaultValue={itemDetails?.status} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
                <p className='text-lg font-medium'>View Assignment</p>
                <input name='viewAssignment' defaultValue={itemDetails?.viewAssignment} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
                <p className='text-lg font-medium'>View</p>
                <input name='view' defaultValue={itemDetails?.view} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
                <p className='text-lg font-medium'> Pending</p>
                <input name='pending' defaultValue={itemDetails?.pending} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
