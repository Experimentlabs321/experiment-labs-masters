...
const AddLearnersDetails = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const pleaseFollowTheGivenTemplateOfXlsxFileToEnterStudentData = form.pleaseFollowTheGivenTemplateOfXlsxFileToEnterStudentData?.value;
    ...
    const itemDetail = {
      ...
      or: or,
      browser: browser,
      pleaseFollowTheGivenTemplateOfXlsxFileToEnterStudentData: pleaseFollowTheGivenTemplateOfXlsxFileToEnterStudentData,
          ...
          <form onSubmit={handleSubmit} className='mt-2 border p-4 rounded-xl '>
            <div className='grid grid-cols-2 gap-4'>
              ...
              <div className='flex justify-between items-center w-[100%]'>
                ...
                <input name='noBatchAddedYet' defaultValue={itemDetails?.noBatchAddedYet} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
                <p className='text-lg font-medium'>File</p>
                <input name='file' defaultValue={itemDetails?.file} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
                <p className='text-lg font-medium'>Enter phone number</p>
                <input name='enterPhoneNumber' defaultValue={itemDetails?.enterPhoneNumber} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
                <p className='text-lg font-medium'>New Users created successfully</p>
                <input name='newUsersCreatedSuccessfully' defaultValue={itemDetails?.newUsersCreatedSuccessfully} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
              ...
              <div className='flex justify-between items-center w-[100%]'>
                ...
                <input name='or' defaultValue={itemDetails?.or} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
              ...
              <div className='flex justify-between items-center w-[100%]'>
                <p className='text-lg font-medium'>Please follow the given template of xlsx file to enter student data</p>
                <input name='pleaseFollowTheGivenTemplateOfXlsxFileToEnterStudentData' defaultValue={itemDetails?.pleaseFollowTheGivenTemplateOfXlsxFileToEnterStudentData} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
                <p className='text-lg font-medium'>Download Template</p>
                <input name='downloadTemplate' defaultValue={itemDetails?.downloadTemplate} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
              ...
              <div className='flex justify-between items-center w-[100%]'>
                ...
                <input name='addStudents' defaultValue={itemDetails?.addStudents} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
              <div className='flex justify-between items-center w-[100%]'>
                <p className='text-lg font-medium'>New User created successfully</p>
                <input name='newUserCreatedSuccessfully' defaultValue={itemDetails?.newUserCreatedSuccessfully} type='text' className='border border-slate-300 rounded-lg p-2 w-[300px]' placeholder='Text here' />
              </div>
