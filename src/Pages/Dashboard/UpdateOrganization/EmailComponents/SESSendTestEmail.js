    ...
    return (
        <div className="w-full my-8">
            <div className="rounded-lg">
                <h2 className="text-xl font-bold text-gray-800 mb-6">Send Test Email</h2>
                <form onSubmit={handleSubmit}>
                    <div className='flex w-full gap-20'>
                        <div className="mb-4 w-full">
                            <label className="block text-gray-700 w-full font-bold mb-2">From</label>
                            <input type="text" name="from" value={email} disabled className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm" placeholder="Template Name" />
                        </div>
                        <div className="mb-4 w-full">
                            <label className="block text-gray-700 w-full font-bold mb-2">To</label>
                            <input type="text" name="to" value={formData.to} onChange={handleChange} className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Receiver's Email" />
                        </div>
                        {/* <div className="mb-4 w-full">
                    ...
                    <button type="submit" className="bg-blue hover:bg-opacity-70 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Send Email
                    </button>
                </form>
            </div>
