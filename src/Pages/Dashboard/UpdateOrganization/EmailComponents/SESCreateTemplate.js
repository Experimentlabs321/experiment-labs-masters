...
const SESCreateTemplate = ({ orgData, email, fetchSESIntegrationData, setShowForm }) => {
    ...
    return (
        <div className="w-full my-8">
            <div className="rounded-lg">
                <h2 className="text-xl font-bold text-gray-800 mb-6">Create Email Template</h2>
                <form onSubmit={handleSubmit}>
                    <div className='flex w-full gap-20'>
                        <div className="mb-4 w-full">
                            <label className="block text-gray-700 w-full font-bold mb-2">Name</label>
                            <input type="text" name="name" value={formData.name} onChange={handleChange} className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Template Name" />
                        </div>
                        <div className="mb-4 w-full">
