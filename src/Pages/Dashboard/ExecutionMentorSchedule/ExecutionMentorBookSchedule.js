...
const ExecutionMentorBookSchedule = ({ selectedSchedule, selectedC, selectedBatch, selectedMax, selectedMin, selected, meetingmedium, offDays, dateRange, scheduleEvents, durationMeeting, addBookOpen, setAddBookOpen, selectedAdmin }) => {
