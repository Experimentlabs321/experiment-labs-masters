...
const AdminBookSchedule = ({
    ...
    useEffect(() => {
        ...
        axios
            .get(
                `${process.env.REACT_APP_SERVERLESS_API}/api/v1/users/getAllUserByCourseId/${fullEventData?.courseId}`
            )
            .then((response) => {
                Loading().close();
                            ...
                            <div className="dropdown-menu mt-[71px] mb-[45px] border-b-2  ">
                                <div className="grid lg:grid-cols-2 grid-cols-1 gap-20">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-4">
                                            <p className="h-2 w-2 bg-black rounded-full"></p>
                                            <p className="font-bold text-lg me-[36px]">Select Student</p>
                                            <img src={required} alt="required" />
                                        </div>
                                        ...
                                        <input
                                            ...
                                            className="mt-6 ms-6 border rounded-md w-[90%] h-[40px] ps-2 text-[#535353] focus:outline-0 bg-[#F6F7FF]"
                                        />

                                        <select
                                            className="mt-3 ms-6 border rounded-md w-[90%] h-[50px] ps-2 text-[#535353] focus:outline-0 bg-[#F6F7FF]"
                                            defaultValue=""
                                        ...
                                        {showModal && selectedStudent && (
                                            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                                                <div className="bg-white p-4 rounded-md">
                                                    <p className="font-bold text-[16px]">Name : {selectedStudent.name}</p>
...
export default AdminBookSchedule;
