...
const OnGoingClasses = () => {
  const [selectedTab, setSelectedTab] = useState("OnGoingClasses");
            ...
            <div className="flex justify-between items-center">
              <div className="px-10 flex gap-10 pb-3 text-lg mt-10  ">
                <Link
                  ...
                  style={{
                    fontWeight:
                      selectedTab === "OnGoingClasses" ? "bold" : "normal",
                    borderBottom:
                      selectedTab === "OnGoingClasses"
                        ? "2px solid black"
                        : "none",
                    color:
                      selectedTab === "OnGoingClasses" ? "none" : "#BEBEBE",
                  }}
                >
                  Ongoing Classes
                </Link>
                  ...
                  style={{
                    ...
                    borderBottom:
                      selectedTab === "upcomingClasses"
                        ...
                        : "none",
                    color:
                      selectedTab === "upcomingClasses" ? "none" : "#BEBEBE",
                  }}
                >
                  Upcoming classes
                </Link>
                ...
                <Link
                  to="/doubtClearing"
                  onClick={() => handleTabClick("doubtClearing")}
                  style={{
                    fontWeight:
                      selectedTab === "doubtClearing" ? "bold" : "normal",
                    borderBottom:
                      selectedTab === "doubtClearing"
                        ? "2px solid black"
                        : "none",
                    color: selectedTab === "doubtClearing" ? "none" : "#BEBEBE",
                  }}
                >
                  Doubt Clearing
                </Link>
