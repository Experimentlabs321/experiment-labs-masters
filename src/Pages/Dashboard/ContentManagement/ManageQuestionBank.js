                                ...
                                (!importQues && !exportQues) && (
                                    <div className="mx-10 my-20">
                                            ...
                                            <div className=' flex items-center'>
                                                <div className=' '>
                                                    ...
                                                    {isOpenEvluationCourseSelection && (
                                                        ...
                                                        >
                                                            <button onClick={handlesetImportQues1}>Import question</button>
                                                            <button onClick={handlesetexportQues1}>Export question</button>
                                        ...
                                        <div className='flex justify-between mt-20 mb-10'>
                                                ...
                                                }
                                                {
                                                    allSelect && (
                                                        <div className='flex  p-2'>
                                                            ...
                                                            <label className=' text-base font-semibold bg-[#E4FFE7] rounded-lg border p-2' htmlFor="Move to">Move to</label>
                                                        </div>
                                                    )
                                                }
                                                {
                                            ...
                                            <div className='flex items-center'>
                                                <div>
                                                    <div variant="outlined" onClick={handleClickopenNewQuesType} className='button w-[100%] bg-[#FF557A] text-[#fff] rounded-lg text-base px-4 py-2 font-semibold flex gap-2 justify-center items-center'>
                                                ...
                                                <table className='w-full'>
                                                    ...
                                                    <tbody className=''>
                                                        ...
                                                        <tr className='bg-[#F2FFFA] '>
                                                            ...
                                                            <td className='flex items-center justify-center'><img src={bxseditalt} /></td>
                                                            <td className='text-center'>Batch 1</td>
                                                            <td className='text-center'>1</td>
                                                            <td className='flex items-center justify-center'><img src={trash} /></td>
                                                        </tr>
                                                        <tr className=''>
                                                            <td className='flex justify-center py-5'>
                                                                <input
                                ...
                                importQues && (
                                    <>
                                        ...
                                        <div className='flex justify-center'>
                                            <p onClick={handlesetImportQues} className='bg-[#3E4DAC] text-[#fff] px-3 py-2 rounded-lg font-bold'>Import Question</p>
                                        </div>
                                    </>
...

                            {
                                exportQues && (
                                    <>
                                        ...
                                        <ExportQuesToFile />
                                        <div className='flex justify-center'>
                                            <p onClick={handlesetExportQues} className='bg-[#3E4DAC] text-[#fff] px-3 py-2 rounded-lg font-bold'>Export Question</p>
                                        </div>
                                    </>
                                )
                            }
