...
const AddingEditingSelectMissingQues = () => {
    const [selectedTab, setSelectedTab] = useState('addingEditingSelectMissingQues');
            ...
            <Layout>
                ...
                <div className='px-10 flex  justify-between pb-3 text-lg'>
                    ...
                    <Link to='/manageQuestion'
                        ...
                        style={{
                            fontWeight: selectedTab === 'Questions' || 'addingEditingSelectMissingQues' ? 'bold' : 'normal',
                            borderBottom: selectedTab === 'Questions' || 'addingEditingSelectMissingQues' ? '2px solid black' : 'none'
                        }}
                    >
                        Questions
                    </Link>
                ...
                <div className="mx-10 mt-10">
                    <div className="flex justify-between items-center mb-10">
                        <p className=" text-[26px] font-bold ">Adding/Editing Select Missing Words Question</p>
                        ...
                        {isOpenCourseFormat && (
                            <div>
                                <div className="text-xl font-medium">
                                    <p> <span className="font-bold text-[#3E4DAC]">Note:</span>You must embed the correct answer in the question title.<span className="font-bold text-[#3E4DAC]">Eg- what is [[1]] used as design tool ?</span></p>
                                </div>
