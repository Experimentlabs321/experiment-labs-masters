...
const AddingEditingMatchingQues = () => {
    const [selectedTab, setSelectedTab] = useState('addingEditingMatchingQues');
            ...
            <Layout>
                ...
                <div className='px-10 flex  justify-between pb-3 text-lg'>
                    ...
                    <Link to='/manageQuestion'
                        ...
                        style={{
                            fontWeight: selectedTab === 'Questions' || 'addingEditingMatchingQues' ? 'bold' : 'normal',
                            borderBottom: selectedTab === 'Questions' || 'addingEditingMatchingQues' ? '2px solid black' : 'none'
                        }}
                    >
                        Questions
                    </Link>
                ...
                <div className="mx-10 mt-10">
                    <div className="flex justify-between items-center mb-10">
                        <p className=" text-[26px] font-bold ">Adding/Editing Matching Question</p>
                        ...
                        {isOpenCourseFormat && (
                            <div>
                                <div className="text-xl font-medium">
                                    <p> <span className="font-bold text-[#3E4DAC]">Note:</span> You must provide at <span className="font-bold text-[#3E4DAC]">least two questions and three answers</span>. You can provide extra wrong answers by giving an answer with a blank question. Entries where both the question and the answer are blank will be ignored.</p>
                                </div>
...
export default AddingEditingMatchingQues;
