...
const AddingEditingTrueFalseQues = () => {
    const [selectedTab, setSelectedTab] = useState('addingEditingTrueFalseQues');
            ...
            <Layout>
                ...
                <div className='px-10 flex  justify-between pb-3 text-lg'>
                    ...
                    <Link to='/manageQuestion'
                        ...
                        style={{
                            fontWeight: selectedTab === 'Questions' || 'addingEditingTrueFalseQues' ? 'bold' : 'normal',
                            borderBottom: selectedTab === 'Questions' || 'addingEditingTrueFalseQues' ? '2px solid black' : 'none'
                        }}
                    >
                        Questions
                    </Link>
                ...
                <div className="mx-10 mt-10">
                    <div className="flex justify-between items-center mb-10">
                        <p className=" text-[26px] font-bold ">Adding/Editing True/False Question</p>
                            ...
                            <div>
                                ...
                                <div className="mt-10 mb-[45px]  me-10 p-5 bg-[#F7F7F7] rounded-lg ">
                                    <div className=' w-[20%]'>
                                        <div className='flex items-center gap-4'>
                                            <p className='h-2 w-2 bg-black rounded-full'></p>
                                            <p className='font-semibold text-[#000000]  py-2'>Correct Answer</p>
                                    ...
                                    <div className=" mt-10 me-10">
                                        ...
                                        <input
                                            className="mt-6 ms-6  border rounded-md w-[100%] h-[50px] ps-2 text-[#535353] focus:outline-0 bg-[#F6F7FF] "
                                            name="feedbackfortheresponse'False' "
                                            type="text"
                                            placeholder=""
                                        />
                                    </div>
...
export default AddingEditingTrueFalseQues;
