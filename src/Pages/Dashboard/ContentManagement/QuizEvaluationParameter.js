...
const QuizEvaluationParameter = () => {
    ...
    // skill category
    const [isOpenEvaluationSkillCategory, setIsOpenEvaluationSkillCategory] = useState(false);
    ...
    // skill Parameter
    const [isOpenEvaluationSkillParameter, setIsOpenEvaluationSkillParameter] = useState(false);
                            ...
                            <form onSubmit={handleSubmit} className='  mt-12'>
                                ...
                                <div className='flex justify-between'>
                                    <div className="select-option flex items-center gap-[40px]" onClick={toggleDropdownEvaluationParameter} >
                                        ...
                                        {
                                            !isOpenEvaluationParameter && <img className='w-6' src={arrowright} alt='arrowRight' />
                                        }

                                        {
                                            isOpenEvaluationParameter && <img src={arrowDown} alt='arrowDown' />
                                        }
                                                                ...
                                                                <Typography gutterBottom>
                                                                    <form className='mt-6 mx-10'>
                                                                        ...
                                                                        <div className='flex items-center gap-4'>
                                                                            ...
                                                                            <img className='mt-5' src={required} alt='required' />
                                                                        </div>
                                            ...
                                            <div className=''>
                                                ...
                                                <div className='bg-[#F6F7FF] mt-6 ms-5 custom-dropdown flex justify-between items-center gap-2  border  rounded-lg h-[40px] w-[100%] px-2 text-[#535353] font-normal '
                                                    ...
                                                    <div className="select-option" onClick={toggleDropdownSkillCategory}>
                                                        ...
                                                        <i className={`dropdown-arrow ${isOpenEvaluationSkillCategory ? 'open' : ''}`}></i>
                                                    </div>
                                                </div>
                                                {isOpenEvaluationSkillCategory && (
                                                ...
                                                <div className=''>
                                                    ...
                                                    <div className=' bg-[#F6F7FF] mt-6 ms-5 custom-dropdown flex justify-between items-center gap-2  border  rounded-lg h-[40px] w-[100%] px-2 text-[#535353] font-normal '
                                                        ...
                                                        <div className="select-option" onClick={toggleDropdownSkillParameter}>
                                                            ...
                                                            <i className={`dropdown-arrow ${isOpenEvaluationSkillParameter ? 'open' : ''}`}></i>
                                                        </div>
                                                    </div>
                                                    {isOpenEvaluationSkillParameter && (
                                                        <div className="dropdown-menu w-[312px] ms-5 mt-2"
                                                        ...
                                                        <div className='flex justify-between'>
                                                            ...
                                                            <div className='mx-10 mt-10 w-1/6 '>
                                                                ...
                                                                <div className={`w-11/12  h-[38px] flex justify-between items-center px-4 py-2 text-sm font-medium ${SoftSkills ? 'text-[#0A98EA] ' : 'text-[black]'}`}
                                                                    ...
                                                                    <p>Soft Skills</p>
                                                                    <img onClick={handleSoftSkill} src={arrowright} alt='arrowRight' />
                                ...
                                <div className='flex items-center justify-between'>
                                    <div className="select-option flex items-center gap-[40px]" onClick={toggleDropdownItemEarningParameter} >
                                        ...
                                        {
                                            !isOpenItemEarningParameter && <img className='w-6' src={arrowright} alt='arrowRight'/>
                                        }

                                        {
                                            isOpenItemEarningParameter && <img src={arrowDown} alt='arrowDown'/>
                                        }
