        ...
        <>
                    ...
                    <div className='px-10 flex gap-10 pb-3 text-lg  '>
                        <button
                            ...
                            style={{
                                ...
                                borderBottom: selectedTab1 === 'Product Lab' ? '2px solid black' : 'none',
                        ...
                        <button
                            ...
                            style={{
                                ...
                                borderBottom: selectedTab1 === 'Business Lab' ? '2px solid black' : 'none',
                        ...
                        <button
                            ...
                            style={{
                                ...
                                borderBottom: selectedTab1 === 'Creative Lab' ? '2px solid black' : 'none',
            ...
            {selectedTab1 === 'Product Lab' && (
                <div className="flex items-center justify-between gap-10 mt-10">
                    ...
                    >
                           <p className=""><img className="" src={img3} alt="img"/></p>

                           <div className="text-[#676767] text-base font-semibold p-5"
