                                ...
                                <div className="my-6 px-5">
                                    ...
                                    <FullCalendar
                                        ...
                                        events={adminCalendarInfo?.events?.map((event, index) => {
                                            ...
                                            const title = event?.summary || event?.topic || "No Title";
                                            const start = event?.start?.dateTime || event?.start || event?.start_time;
                                            const end = event?.end?.dateTime || event?.end || event?.end_time || start;
                                            const link = event?.hangoutLink ;
                                            const description = event?.description || event?.start_url;
