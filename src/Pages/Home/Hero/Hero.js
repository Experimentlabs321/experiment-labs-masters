                ...
                <div style={{ height: "100%", backgroundImage: "linear-gradient(to top left, #000000 -10%, rgba(0, 0, 0, 0.6096) 35.55%, rgba(0, 0, 0, 0) 100%)", backgroundColor: '#6278FF' }} className="flex lg:justify-end items-center">
                    <div className="relative">
                        <div className='pt-28 pb-20 px-10 lg:pr-10 lg:-mr-56 lg:pl-10'>
                            <h1 className="text-5xl font-extrabold">Discover Your Path to Success <br />
                                with Real-World Experience</h1>
                            <p className='mt-8 mb-12 font-medium text-3xl'>Build leadership like a muscle</p>
                            ...
                            <Button onClick={onButtonClick} sx={{ bgcolor: '#FF557A', ":hover": { bgcolor: '#94A4FF' }, padding: '10px 30px 10px 50px', color: 'white', fontWeight: "700", fontSize: '22px', textTransform:'initial', borderRadius:'45px' }} variant="contained" endIcon={<ArrowForwardIosIcon className='h-6 w-6' />}>
                                Learn More
                            </Button>
                        </div>
