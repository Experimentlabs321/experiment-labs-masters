    ...
    return (
        <div className='mt-44 px-10 lg:px-28'>
            <div className='mb-10 flex justify-between items-start'>
                <div>
                    <h1 className='text-2xl xl:text-4xl font-extrabold font-serif'><span className='bg-gradient-to-t from-custom-blue to-transparent to-50%'>Experience the Union</span></h1>
                </div>
            ...
            <div
                ref={containerRef}
                className='flex overflow-x-scroll scroll-smooth gap-5 eu-container'
            >
                <div className='border-2 border-dark hover:shadow-xl hover:transition-all hover:duration-200 hover:ease-out hover:shadow-custom-blue min-w-[290px] max-w-[290px] rounded-xl'>
                    <img
                    ...
                    />
                    <div className='p-3'>
                        <h4 className='font-extrabold font-serif text-xl'>The Masters' Union Startup Weekend</h4>
                        <div className='text-xs font-bold mt-5 flex gap-3'>
                            <span className='px-2 p-1 bg-custom-blue bg-opacity-40 rounded-full'>6th May 2023 - 7th May 2023</span>
                            <span className='px-2 p-1 bg-custom-blue bg-opacity-40 rounded-full'>Offline</span>
                        </div>
