                ...
                <div className='flex flex-col lg:flex-row gap-16 justify-center items-center'>
                    ...
                    <div className='h-full'>
                        ...
                        <div className='mt-2'>
                            ...
                            <p className='font-thin mt-2 text-sm'>Includes 7 day industry immersion</p>
                        </div>
                    </div>
                    <div className='lg:border-l border-t lg:border-t-0 lg:pt-0 pt-8 lg:px-8  ' style={{borderLeft:"6px solid rgba(85, 96, 211, 0.5)"}}>
                        <div className='flex gap-2 items-center text-sm'>
                            <LocationOnIcon />
                            <span>Location</span>
                        </div>
                        <div className='mt-2'>
                            ...
                            <p className='font-thin mt-2 text-sm'>Online and in campus
                            </p>
                        </div>
                    </div>
                    <div className='lg:border-l border-t lg:border-t-0 lg:pt-0 pt-8 lg:px-8' style={{borderLeft:"6px solid rgba(85, 96, 211, 0.5)"}}>
                    ...
                    <div className='lg:border-l border-t lg:border-t-0 lg:pt-0 pt-8 lg:px-8 h-full' style={{borderLeft:"6px solid rgba(85, 96, 211, 0.5)"}}>
                        <div className='flex gap-2 items-center text-sm'>
                            <CalendarTodayIcon />
